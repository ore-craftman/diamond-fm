...
const Policy = () => {
  ...
  useEffect(() => {
    document.title = "Privacy Policy | DiamondFM";
  ...
  return (
    <div>
      ...
      <Container>
        <p>
          Privacy Policy Last updated: March 30, 2021 This Privacy Policy
          ...
          and Definitions Interpretation The words of which the initial letter
          ...
          whether they appear in singular or in plural. Definitions For the
          purposes of this Privacy Policy: � Account means a unique account
          created for You to access our Service or parts of our Service. �
          Company (referred to as either "the Company", "We", "Us" or "Our" in
          this Agreement) refers to Diamond FM Ilorin, Plot 2, New Yidi Road,
          Irewolede, Ilorin. � Cookies are small files that are placed on Your
          computer, mobile device or any other device by a website, containing
          the details of Your browsing history on that website among its many
          uses. � Country refers to: Nigeria � Device means any device that can
          ...
          duration of a page visit). � Website refers to Diamond FM, accessible
          from <a href="www.diamondfm.net">www.diamondfm.net</a> � You means the
          ...
          the Service, as applicable. Collecting and Using Your Personal Data
          ...
          ZIP/Postal code, City � Usage Data Usage Data Usage Data is collected
          ...
          will refuse Cookies, our Service may use Cookies. � Flash Cookies.
          ...
          About Cookies by TermsFeed. We use both Session and Persistent Cookies
          ...
          preferences every time You use the Website. For more information about
          the cookies we use and your choices regarding cookies, please visit
          our Cookies Policy or the Cookies section of our Privacy Policy. Use
          of Your Personal Data The Company may use Personal Data for the
          ...
          is transferred and becomes subject to a different Privacy Policy. Law
          ...
          the rights or property of the Company � Prevent or investigate
